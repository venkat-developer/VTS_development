...
<title>HITS-Output Validation</title>
					...
					<div class="large-11 columns" style="height: 100%">
						...
						<p>
							<strong><h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; OUTPUT EXCEL FILES VALIDATION</h3></strong>
						<div class="large-4 columns">
							...
							<fieldset>
								...
								<form action="/HITS-UI/busOutputFileValidator.do" method="post"
						...
						<div class="large-4 columns">
							...
							<fieldset>
								...
								<form action="/HITS-UI/stopsOutputFileValidator.do" method="post"
									enctype="multipart/form-data">
						...
						<div class="large-4 columns">
							...
							<fieldset>
								...
								<form action="/HITS-UI/conductorOutputFileValidator.do"
						...
						<div class="large-4 columns">
							...
							<fieldset>
								...
								<form action="/HITS-UI/depotOutputFileValidator.do" method="post"
									enctype="multipart/form-data">
						...
						<div class="large-4 columns">
							...
							<fieldset>
								...
								<form action="/HITS-UI/divisionOutputFileValidator.do"
									method="post" enctype="multipart/form-data">
						...
						<div class="large-4 columns">
							...
							<fieldset>
								...
								<form action="/HITS-UI/driverOutputFileValidator.do"
									method="post" enctype="multipart/form-data">
						...
						<div class="large-4 columns">
							...
							<fieldset>
								...
								<form action="/HITS-UI/farechartOutputFileValidator.do"
									method="post" enctype="multipart/form-data">
						...
						<div class="large-4 columns">
							...
							<fieldset>
								...
								<form action="/HITS-UI/routesOutputFileValidator.do"
									method="post" enctype="multipart/form-data">
						...
						<div class="large-4 columns">
							...
							<fieldset>
								...
								<form action="/HITS-UI/typeOutputFileValidator.do" method="post"
									enctype="multipart/form-data">
 ...
 -->
						...
						<div class="large-4 columns">
							...
							<fieldset>
								...
								<form action="/HITS-UI/usersOutputFileValidator.do" method="post"
									enctype="multipart/form-data">
						...
						<div class="large-4 columns">
							...
							<fieldset>
								...
								<form action="/HITS-UI/wifiOutputFileValidator.do" method="post"
									enctype="multipart/form-data">
