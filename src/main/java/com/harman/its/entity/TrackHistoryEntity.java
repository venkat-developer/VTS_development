 ...
 * 
 */
public class TrackHistoryEntity implements IEntity<TrackHistoryEntity> {
	...
	public TrackHistoryEntity(LongPrimaryKey id, long tripid, float gpsSignal,
	...
	public TrackHistoryEntity(float speed, Date occuredat, Geometry location, float cumulativeDistance,
	...
	public TrackHistoryEntity(float distance, float speed) {
		this.distance = distance;
		this.speed = speed;
	}
	...
	@Override
	public boolean equalsEntity(TrackHistoryEntity object) {
