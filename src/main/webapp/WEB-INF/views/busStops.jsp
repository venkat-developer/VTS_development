...
<title>HITS-Upload Bus Stop Details</title>
				...
				<section class="main-section">
					...
					<div class="large-11 columns" style="height: 92.5%">
						...
						<div class="large-6 push-3 columns">
							...
							<form action="/HITS-UI/healthsync.do?type=history&opt=2"
								...
								<fieldset>
									...
									<div class="large-9 push-1 small-6 columns">
										<select name="route" id="route" required>
											...
											<c:forEach items='${stoplist}' var="stops">
												<option value='${stops.stopName}'>${stops.stopName}</option>
											</c:forEach>
